...
public class SaveJobServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        SaveJobDAO dao = new SaveJobDAO();

        if (dao.isJobSaved(userId, jobId)) {
            dao.unsaveJob(userId, jobId);
        } else {
            dao.saveJob(userId, jobId);
        }

        response.sendRedirect(request.getContextPath() + "/views/showsavejob");
    }
