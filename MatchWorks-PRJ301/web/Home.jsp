    ...
    <body>
        ...
        <header class="mw-header">
            <div class="mw-container mw-header__inner">
                ...
                <!-- NAV -->
                <nav class="mw-nav" aria-label="Điều hướng chính">
                    <!-- VIỆC LÀM -->
                    <div class="mw-dd" data-dd="jobs">
                        <button class="mw-link mw-link--caret" type="button"
                                aria-haspopup="true" aria-expanded="false" data-dd-trigger>
                            Việc làm
                        </button>

                        <div class="mw-mega" role="menu" aria-label="Menu việc làm" data-dd-panel>
                            <div class="mw-mega__inner">
                                <!-- LEFT -->
                                <div class="mw-mega__left">
                                    <div class="mw-mega__group-title">VIỆC LÀM</div>

                                    <a class="mw-mega__item" href="#">
                                        <span class="mw-mega__icon">🔎</span>
                    ...
                    <div class="mw-dd" data-dd="cv">
                        ...
                        <div class="mw-mega " role="menu" aria-label="Menu tạo CV" data-dd-panel>
                            <div class="mw-mega__inner">
                                <div class="mw-mega__left mw-mega__left--single">
                                    <div class="mw-mega__group-title">TẠO CV</div>
                    ...
                    <a class="mw-link" href="#">Công ty</a>
                    <a class="mw-link" href="#">Cẩm nang nghề nghiệp</a>
                </nav>

                <!-- ACTIONS -->
                <div class="mw-actions">
                    <button class="mw-btn mw-btn--ghost" type="button">Đăng nhập</button>
                    <button class="mw-btn mw-btn--primary" type="button">Đăng ký</button>
                </div>
            </div>
        </header>
