...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const salaryOptions = ["Tất cả", "Dưới 10 triệu", "10 - 20 triệu", "20 - 30 triệu", "30 - 50 triệu", "Trên 50 triệu", "Thỏa thuận"];
    const expOptions = ["Tất cả", "Dưới 1 năm", "1 năm", "2 năm", "3 năm", "Trên 3 năm"];
    ...
    filterType.addEventListener("change", () => renderFilters(filterType.value));
    renderFilters(filterType.value || "salary");
});
