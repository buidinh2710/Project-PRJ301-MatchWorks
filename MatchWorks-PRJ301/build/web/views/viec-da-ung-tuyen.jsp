        ...
        <section class="saved-jobs-section">
            ...
            <div class="saved-jobs-left">
                <h2 class="section-title">
                    Danh sách <span>3</span> việc làm đã ứng tuyển
                </h2>
                ...
                <div class="job-card">
                    <div class="job-details">
                        <h2>Lập trình viên Java Senior</h2>
                        <p class="company">Công ty Công Nghệ ABC</p>
                        <p><b>Địa chỉ:Quận 1, TP. HCM</b> </p>
                        <p><b>Yêu cầu:</b>3 năm</p>
                        <p class="salary">Mức lương: 25 - 35 triệu</p>
                    </div>
