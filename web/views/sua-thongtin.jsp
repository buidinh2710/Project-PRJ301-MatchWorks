<%-- 
    Document   : sua_thongtin
    Created on : Mar 12, 2026, 3:50:41 PM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/sua-thongtin.css">
        ...
        <section class="profile-section">
            ...
            <div class="profile-container">
                ...
                <div class="card profile-form-card">
                    ...
                    <p class="required">(*) Các thông tin bắt buộc</p>

                    <form action="${pageContext.request.contextPath}/views/updateUser" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password" placeholder="Nhập mật khẩu (không đổi mật khẩu có thể để trống)">
                        </div>
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" name="email" value="${sessionScope.user.gmail}">
                        </div>
                ...
                <div class="profile-sidebar">
                    ...
                    <div class="card welcome-card">
                        <h3>Chào bạn trở lại,</h3>
                        <h2>${sessionScope.user.fullName}</h2>
                    </div>

                    <div class="banner-card">
                        <img src="${pageContext.request.contextPath}/static/images/Login-SignIn/login-signin.png" alt="MatchWorks">
                    </div>
                </div>
            </div>
        </section>
